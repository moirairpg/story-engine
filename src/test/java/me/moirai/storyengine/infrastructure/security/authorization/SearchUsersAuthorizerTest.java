...
import me.moirai.storyengine.infrastructure.security.authorization.user.SearchUsersAuthorizer;

@ExtendWith(MockitoExtension.class)
class SearchUsersAuthorizerTest {

    @InjectMocks
    private SearchUsersAuthorizer authorizer;

    @Test
    void shouldReturnSearchUsersOperation() {

        assertThat(authorizer.getOperation()).isEqualTo(AuthorizationOperation.SEARCH_USERS);
    }
