...
import me.moirai.storyengine.infrastructure.security.authorization.user.UpdateUsersActiveStateAuthorizer;

@ExtendWith(MockitoExtension.class)
class UpdateUsersActiveStateAuthorizerTest {

    @InjectMocks
    private UpdateUsersActiveStateAuthorizer authorizer;

    @Test
    void shouldReturnUpdateUsersActiveStateOperation() {

        assertThat(authorizer.getOperation()).isEqualTo(AuthorizationOperation.UPDATE_USERS_ACTIVE_STATE);
    }
