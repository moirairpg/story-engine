...
@Component
public class ReactiveTextModerationAdapter implements ReactiveTextModerationPort {
    ...
    public ReactiveTextModerationAdapter(@Value("${moirai.openai.api.base-url}") String baseUrl,
