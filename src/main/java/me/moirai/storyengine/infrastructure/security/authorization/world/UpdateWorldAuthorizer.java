...
public class UpdateWorldAuthorizer implements OperationAuthorizer {

    private final WorldRepository worldRepository;

    public UpdateWorldAuthorizer(WorldRepository worldRepository) {
        this.worldRepository = worldRepository;
    }

    @Override
    public AuthorizationOperation getOperation() {
        return AuthorizationOperation.UPDATE_WORLD;
    }
