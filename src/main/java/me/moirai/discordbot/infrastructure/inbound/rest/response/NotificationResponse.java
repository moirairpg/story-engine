...
public class NotificationResponse {
    ...
    private List<NotificationReadResponse> notificationsRead;
    ...
    public List<NotificationReadResponse> getNotificationsRead() {
    ...
    public static final class Builder {
        ...
        public Builder notificationsRead(List<NotificationReadResponse> notificationsRead) {
